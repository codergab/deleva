    ...
    <View className="bg-[#00CCBB] flex-1">
      <SafeAreaView className="z-50">
        ...
        <View className="bg-white mx-5 my-2 rounded-md p-6 z-100 shadow-md">
          ...
          <Progress.Bar indeterminate color="#00CCBB" size={30} />
      ...
      <SafeAreaView className="bg-white flex-row items-center space-x-5 h-28">
        <Image className="h-12 w-12 bg-gray-300 p-4 rounded-full ml-5" />
        <View className="flex-1">
          <Text className="text-lg">Sonny Songha</Text>
